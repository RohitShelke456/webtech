    ...
    <div className="row">
      <div className="col-lg-3 col-md-6 col-sm-6">
        <div className="footer-menu">
          <img src="images/chocolat/rslogo.png" alt="logo" />
  ...
  <div className="container-fluid">
    <div className="row">
      <div className="col-md-6 copyright text-center">
        <p>© 2025 RS WEBTECH.com . All rights reserved.</p>
      </div>
      <div className="col-md-6 credit-link text-start text-md-center">
        <p><a href="https://templatesjungle.com/">RS WEBTECH.com</a> Distributed by <a href="https://lnkd.in/d8wDeDPZ">RohitShelke</a></p>
      </div>
    </div>
  </div>
</div>
